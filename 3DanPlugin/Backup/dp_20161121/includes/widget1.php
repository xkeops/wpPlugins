 ...
 */
add_action( 'wp_enqueue_scripts', 'dp3_add_my_stylesheet' );

/**
 * Enqueue plugin style-file
 */
function dp3_add_my_stylesheet() {
    // Respects SSL, Style.css is relative to the current file
   $pPluginCss = plugins_url( 'css/dp3_widget1_style.css', dirname( __FILE__ ) );

    wp_register_style( 'prefix-style', $pPluginCss );
...
class My_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo __( '<div class="dp3_widget_1">Goal: <b>'.$dp3_goal.' km</b><br/>Run: <b>'.$dp3_entries.' km</b></div>', 'text_domain' );
